...
<form class="needs-validation" name='addDepositForm' id='addDepositForm' method='post' action="/hiringrequests/addhiringrequest" novalidate>
    ...
    <div class="card mb-g">
        ...
        <div class="col-md-12 mt-3 mb-3">
            ...
            <input class="form-control" placeholder="Enter Cheque No" type="number" id="cheque_no" name="cheque_no" required="">
            <div class="invalid-feedback">
                Cheque No.
            </div>
        </div>
