    ...
    <div id="content">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
                <a href="/user_added" class="btn btn-primary float-right bg-brand-gradient" type="button"><i
                     ...
                     ?>
                                        <tr style="cursor:pointer" onClick="">
                                            ...
                                            <td style="padding:6px 12px;">
                                                <center>
                                                    <a href="/Users/UserEdit/<?php echo $users[$i]['user_id']?>"
                                                    ...
                                                    <button class="btn btn-sm btn-primary bg-brand-gradient"
                                                        title="Delete Branch"><i class="fal fa-times"></i></button>
                                                </center>
                                            </td>
                                        </tr>
                                        <?php }?>
