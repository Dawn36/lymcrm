...
<main id="js-page-content" role="main" class="page-content">
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Tenancy Archive</li>
                    ...
                    <div id="panel-1" class="panel">
                        <div class="panel-container show">
                            <div class="panel-content">
                                <table id="renu_datatable_tabletools_2" class="table table-bordered table-hover table-striped w-100 dataTable dtr-inline">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#renu_datatable_tabletools_2').dataTable({
            responsive: true,
            lengthChange: false,
            dom:
                /*  --- Layout Structure 
