...
<main id="js-page-content" role="main" class="page-content">
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Edit Ward</li>
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
      <h1> <span class="page-title txt-color-blueDark">Edit Ward</span></h1>
    </div>
            ...
            <div id="panel-1" class="panel">
                <div class="panel-container show">
                    <div class="panel-content">
                        <form class="needs-validation" method="post" action="/Ward/UpadateWard" id='editwardform' name='editwardform' >
                            <input type="hidden" name="id" value="<?php echo $ward[0]['ward_id'] ?>">
                             <div class="form-row">
                  <div class="col-md-6 mb-3">
                      <label class="form-label">Ward No<span class="text-danger">*</span></label>
                      <input class="form-control" placeholder="Enter Ward No" type="text" id='ward_no' name='ward_no' value="<?php echo $ward[0]['ward_no'] ?>" required="">
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      <input class="form-control" placeholder="Enter Ward Department" type="text" id='ward_depart' name='ward_depart' value="<?php echo $ward[0]['ward_depart'] ?>" required="">
