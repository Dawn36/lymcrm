...
<main id="js-page-content" role="main" class="page-content">
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Admin Edit</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    
    <div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
      <h1> <span class="page-title txt-color-blueDark">Edit Adim</span></h1>
    </div>
            ...
            <div id="panel-1" class="panel">
                <div class="panel-container show">
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      <input class="form-control" placeholder="Enter Name" type="text" id='admin_name' name='admin_name' value="" required="">
