                        ...
                        <div class="panel-container show">
                            <div class="panel-content">
                                <table id="datatable_tabletools_owner"
                                    ...
                                    <tbody>
                                     <?php for ($i=0; $i <count($getOwnerproperty);$i++) { 
                                        
                                     ?>
                                        <tr>
                                            <td>
                                                <center><?php echo $getOwnerproperty[$i]['building_name'] ?></center>
                                            </td>
                                            <td>
                                                <center><?php echo $getOwnerproperty[$i]['building_address'] ?></center>
                                            </td>
                                            <td>
                                                <center><?php echo $getOwnerproperty[$i]['building_community'] ?></center>
                                            </td>
                                            <td>
                                                <center><?php echo $getOwnerproperty[$i]['apartment_number'] ?></center>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
